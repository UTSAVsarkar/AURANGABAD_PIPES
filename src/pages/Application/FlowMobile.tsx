...
const COMMON_TOP: Stage[] = [
    ...
    { id: "cooling", tag: "06 · Thermal", title: "Cooling Bed", desc: "The sized tube passes over a cooling bed and air-cools at a controlled speed — no water quench. This lets the steel cool evenly so the correct microstructure sets before straightening or cold drawing." },
    { id: "mother", tag: "07 · Intermediate", title: "Mother Hollow Tube", output: true, desc: "This is the common intermediate product for the whole plant — every finished tube, hot finished or cold drawn, starts from a mother hollow tube of this size." },
];

const HFS: Stage[] = [
    { id: "str1", tag: "08 · HFS", title: "Straightening", route: "hfs", desc: "Fresh off the sizing mill, the hot finished tube passes through a straightener to correct ovality and camber picked up during rolling." },
    { id: "hfs", tag: "09 · HFS Output", title: "HFS Tubes", output: true, route: "hfs", desc: "Hot Finished Seamless tubes — finished directly from the hot-rolling line with no cold work, suited to structural and lower-tolerance applications." },
];

const CDS: Stage[] = [
    { id: "surf", tag: "10 · CDS", title: "Surface Treatment", route: "cds", desc: "Pickling and lubricant coating prepare the tube surface so it can pass through the cold-drawing die and plug without galling or tearing." },
    { id: "draw", tag: "11 · CDS", title: "Cold Drawing", route: "cds", desc: "The tube is pulled through a precision die and internal plug at room temperature, tightening the OD, wall, and roundness tolerances well beyond hot-rolled limits." },
    { id: "heat", tag: "12 · CDS", title: "Heat Treatment", route: "cds", desc: "Normalizing or annealing relieves the internal stresses introduced by cold drawing and restores the steel’s mechanical properties." },
    { id: "str2", tag: "13 · CDS", title: "Straightening", route: "cds", desc: "A final straightening pass corrects any bow introduced during heat treatment before the tube rejoins the common line." },
];

const COMMON_BOTTOM: Stage[] = [
    { id: "ect", tag: "14 · Test", title: "ECT", desc: "Eddy Current Testing sends an electromagnetic field through the tube wall to flag surface and near-surface flaws without cutting the tube open." },
    { id: "hydro", tag: "15 · Test", title: "Hydro Testing", desc: "Each tube is pressurized with water above its rated working pressure to confirm it holds without leaking or deforming." },
    { id: "visual", tag: "16 · Test", title: "Visual Inspection", desc: "Manual and automated checks confirm surface finish, dimensions, and end condition against the order specification." },
    { id: "coat", tag: "17 · Finishing", title: "Coating & Stencil", desc: "A protective lacquer or coating is applied and each tube is stencilled with its size, grade, and heat number for traceability — the last step before packing." },
    { id: "pack", tag: "18 · Logistics", title: "Packing & Dispatch", desc: "Tubes are bundled, tagged with heat number and spec, and loaded for shipment — the last stop before they leave the mill." },
    { id: "final", tag: "19 · Finished Product", title: "Finished Seamless Tube", output: true, desc: "The finished tube, either HFS or CDS grade depending on the route it took, ready for the customer — traceable back to its original billet heat." },
];
